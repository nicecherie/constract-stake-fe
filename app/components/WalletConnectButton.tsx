...
const WalletConnectButton = () => {
  ...
  return (
    <div
      className="fixed top-4 right-4 z-50 flex flex-col sm:flex-row items-end
       sm:items-center space-y-2 sm:space-y-0 sm:space-x-3"
    >
      <div className="flex items-center space-x-2 px-2 py-1.5 sm:px-3 sm:py-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full border-2 border-gray-300/50 dark:border-gray-600/50 shadow-lg">
      ...
      <motion.button
        ...
        className="flex items-center space-x-2 px-3 py-1.5 sm:px-4 sm:py-2
         bg-gradient-to-r from-red-500 to-orange-500 rounded-full text-white
        ...
        {isDropdownOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-12 w-56 sm:w-64 bg-gradient-to-b
               from-gray-900/95 to-gray-800/95 backdrop-blur-xl border
                border-gray-700/50 rounded-xl shadow-2xl z-50"
            >
              {/* 钱包信息 */}
