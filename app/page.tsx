...
export default function Home() {
  ...
  // 检查合约状态
  useEffect(() => {
    if (stakeContract && isConnected && address && poolData) {
      console.log('Contract address: ', stakeContract)
  ...
  const handleStake = async () => {
    ...
    try {
      ...
      console.log('Transcation hash: ', tx)

      const res = await waitForTransactionReceipt(publicClient, { hash: tx })
      console.log('Transcation receipt: ', res)
      ...
      setLoading(false)
      console.log('Stake error Details:', error)
      toast.error(
        `Stake failed: ${
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      setClaimLoading(false)
      console.log('Claim error Details:', error)
      toast.error(
        `Claim failed: ${
          error instanceof Error ? error.message : 'Unknown error'
        }`
              ...
              <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="glass-morphism rounded-2xl sm:rounded-3xl p-4 sm:p-6
                  ...
                  >
                    <div
                      className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12
                        bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full mb-3 sm:mb-4"
                    >
